...
export default function Hero({heroImage}) {
  ...
  return (
    ...
    <div
        ...
        <Navbar />
          <div class="flex flex-col text-left pt-72 pl-28 fixed  ">
          
          <h3 class="font-semibold drop-shadow-lg text-white text-4xl">Be Consistent And No Excuses.</h3>
      ...
      {/* <Container className="flex flex-wrap "> */}
        {/* <div class="h-screen bg-[url('../public/img/herobg.jpg')] bg-no-repeat bg-cover bg-fixed blur-[2px]">
        </div> */}
