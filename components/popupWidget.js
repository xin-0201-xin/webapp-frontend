  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-red-500 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-red-700 focus:bg-red-500
             ease">
                ...
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-red-500 rounded-md focus:bg-red-500 focus:outline-none">
                          {isSubmitting ? (
                            <svg
                  ...
                  {isSubmitSuccessful && !isSuccess && (
                    <div className="flex flex-col items-center justify-center h-full text-center text-white rounded-md">
                      ...
                      <p className="text-gray-700 md:px-3">{Message}</p>
                      <button
                        className="mt-6 text-red-500 focus:outline-none"
                        onClick={() => reset()}>
                        Go back
                      </button>
                    </div>
